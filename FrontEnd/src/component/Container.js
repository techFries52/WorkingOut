            ...
            <Router> 
                ...
                <Switch>
                    <Route path="/" exact render={(workouts) => (
                        <HomePage workouts={workouts} workoutSelect={this.workoutSelect} workoutDeselect={this.workoutDeselect} />
                    )}
                    />
                    
                    <Route path="/workout" render={(selectedWorkouts) => (
                        <WorkoutPage selectedWorkouts={selectedWorkouts} workoutCompleted={this.workoutCompleted} />
                    )} />
                </Switch>          
            </Router>
        )
